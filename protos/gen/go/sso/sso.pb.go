...
type IsAdminResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	AsAdmin       bool                   `protobuf:"varint,1,opt,name=as_admin,json=asAdmin,proto3" json:"as_admin,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *IsAdminResponse) GetAsAdmin() bool {
	if x != nil {
		return x.AsAdmin
	}
	return false
...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\bas_admin\x18\x01 \x01(\bR\aasAdmin2\xab\x01\n" +
	"\x04Auth\x129\n" +
	"\bRegistor\x12\x15.auth.RegisterRequest\x1a\x16.auth.RegisterResponse\x120\n" +
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponse\x126\n" +
	"\aIsAdmin\x12\x14.auth.IsAdminRequest\x1a\x15.auth.IsAdminResponseB\x13Z\x11tuzov.sso.v1;ssovb\x06proto3"
...
var file_sso_sso_proto_depIdxs = []int32{
	0, // 0: auth.Auth.Registor:input_type -> auth.RegisterRequest
	2, // 1: auth.Auth.Login:input_type -> auth.LoginRequest
	4, // 2: auth.Auth.IsAdmin:input_type -> auth.IsAdminRequest
	1, // 3: auth.Auth.Registor:output_type -> auth.RegisterResponse
